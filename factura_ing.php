...
<html>
<head>
<title>Seguimiento Orden de Trabajo</title>
</head>
...
// if(isset($_SESSION["continuar"])){
 ...
 <table width="80%" align="center" border="1">
           ...
           <tr>
			 ...
			 <tr>
              <th align="left"><strong><?php echo "Forma Pago";?> </strong> </td>
			  <td align="left"> <?php echo $_SESSION['for_pag'].encadenar(2);?></td>
			  ...
			  <td align="right"><?php echo number_format($_SESSION['monto'] - $_SESSION['descuento']  , 2, '.',','); ?></td>
  	...
  	<center>
	<input type="submit" name="accion" value="Graba-Fac">
...
header('Location: ord_imp_com.php');	 
  ...
  <div id="FooterTable">
<BR><B><FONT SIZE=+2><MARQUEE>Ingrese Datos complementario / Factura</MARQUEE></FONT></B>
   </div>
   <?php
