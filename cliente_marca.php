...
<html>
<head>
<title>Marcar Recordatorio a Clientes</title>
    	...
    	<?php
            ...
            <div id="TitleModulo">
            	 <img src="images/24x24/001_36.png" border="0" alt="Modulo">
                    Marcar Recordatorio a Clientes
            </div>
             <div id="AtrasBoton">
...
if ($_SESSION['continuar'] == 2){
 ...
 <?php	
	...
	if(isset($_POST["recor"])){
      $recor= 1; 
	  $act_cli_baja  = "update cliente_general set CLIENTE_VIVIEN=$recor
		                     where CLIENTE_COD =$codigo and CLIENTE_USR_BAJA is null";
...
//	while ($linea = mysql_fetch_array($resultado)) {
	...
	//	  $act_cli_baja  = "update cliente_general set CLIENTE_VIVIEN='$logi'
...
<div id="FooterTable"> 
Marque el recordatorio del Cliente
</div>
        <?php
