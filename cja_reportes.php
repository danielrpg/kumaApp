...
//$resultado = mysql_query($consulta)or die('No pudo seleccionarse tabla')  ;
 ?>
  <div id="ListaSeleccion">
             <ul>
			    <li><a href="cja_rep_op.php?accion=1">Detalle de Movimientos</a></li>
				<li><a href="cja_rep_op.php?accion=2">Detalle Credito</a></li>
    			<li><a href="cja_rep_op.php?accion=3">Detalle Ingresos/Egresos</a></li>
                <li><a href="cja_rep_op.php?accion=4">Planilla Operador</a></li>
