...
<html>
<head>
<title>Alta de Cronograma</title>
</head>
...
if(isset($_SESSION['form_buffer'])){
 ...
 <table width="80%" align="center" border="1">
		   ...
		   <tr>
			  ...
			  <td align="left"><select name="cod_ser" size="1"  >
			  <?php while ($lin_tse = mysql_fetch_array($res_tse)) { ?>
             <option value=<?php echo $lin_tse['GRAL_PAR_PRO_CTA1']; ?>>
			 <?php echo $lin_tse['GRAL_PAR_PRO_CTA1'].encadenar(2).$lin_tse['GRAL_PAR_PRO_DESC']; ?> </option>
	  	     <?php } ?> 
            </select></td>
		   </tr>
		 </table>
	...
	<tr>
              ...
              <td><input type="text" name="com_825" maxlength="60"  size="60" value = ""> </td>
            </tr>
  	<center>
	<input type="submit" name="accion" value="Graba Crono">
