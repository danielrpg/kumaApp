...
$_SESSION['monto_t'] = 0;
$_SESSION['descrip'] = 0;
//echo encadenar(32)."Ingresos Operador".encadenar(2).$_SESSION['nom_ope'];
?>
<br><br>
...
$consulta  = "Select * From temp_ctable  where temp_tipo = 1 order by temp_debe_2";
    ...
    while ($linea = mysql_fetch_array($resultado)) {
	   ...
	   $con_cga  = "Select * From gral_cta_ingegre where gral_ingegre_cta = 110 and gral_ingegre_tip = 1 ";
...
$consulta  = "Select * From temp_ctable  where temp_tipo = 3 order by temp_debe_2";
	...
	$fec_serv = $linea['temp_fec1'];
	$fec_pag = $linea['temp_fec2'];
	$monto = $linea['temp_haber_1'];
	$clie = $linea['temp_des_cta'];
	$orden = number_format($linea['temp_debe_2'],0, '.',''); 
	$cod_ope = $linea['temp_tip_tra'];
	
			 
$con_cred = "insert into ord_credito(ord_cre_nro, 
                                     ord_cre_fserv,
									 ord_cre_fcob,
									 ord_cre_impo,
									 ord_cre_clie,
									 ...
									 ord_cre_fch_hr_baja
											   ...
											   '$logi',
											    ...
											    null,
											    '0000-00-00 00:00:00')";
$res_cred = mysql_query($con_cred)or die('No pudo insertar ord_credito : ' . mysql_error());  
