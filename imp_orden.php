...
//graba recordatorio
 ...
 if(isset($_SESSION["fec_rec"])){
    $fec_rec = $_SESSION['fec_rec'];
    $fec_rec2 = cambiaf_a_mysql($fec_rec);
	$consulta = "insert into ord_recordatorio(ord_rec_nro, 
                                        ord_rec_fserv,
									    ord_rec_frec,
									    ord_rec_usr_alta,
									    ord_rec_fch_hr_alta,
									    ...
									    values ($nro_ord,
												...
												null,
												'0000-00-00 00:00:00')";
$resultado = mysql_query($consulta)or die('No pudo insertar ope_recordatorio : ' . mysql_error());
}
//Grabar detalle   
...
<table width="120%"  border="1" cellspacing="1" cellpadding="1" align="center">	 	
   ...
   <tr>
	...
	<?php echo encadenar(2).$_SESSION['barrio'].encadenar(2);?><br> </td>
...
<table width="120%"  border="1" cellspacing="1" cellpadding="1" align="center">	 	 
  ...
  <?php
    ...
    <tr>
	 ...
	 <tr>
		...
		<?php if(isset($_SESSION["can_dias"])){?>
     ...
     <table width="120%" align="center" border="1">
	  ...
	  <tr>
		...
		<?php echo $_SESSION['desc1_803'].encadenar(47).$_SESSION['c_803']; ?> </th>
	 ...
	 <table width="120%" align="center" border="1">
	  	<tr>
        <th width="40%" align="left" style="font-size:12px">
		<?php echo $_SESSION['desc1_806'].encadenar(45).$_SESSION['c_806']; ?> </th>
     ...
     <table width="120%" align="center" border="1">
       <tr>
        <th width="40%" align="left" style="font-size:12px">
		<?php echo $_SESSION['desc1_825'].encadenar(37).$_SESSION['c_825']; ?> </th>
	 ...
	 <tr>
        <th width="40%" align="left" style="font-size:12px">
		<?php echo $_SESSION['desc1_826'].encadenar(52).$_SESSION['c_826']; ?> </th> 
	 ...
	 <tr>
        <th width="40%" align="left" style="font-size:12px"><?php echo "DESCUENTO"; ?> </th> 
		<td width="80%" align="right"><?php echo number_format($_SESSION['descuento'], 2, '.',','); ?></td>
	 </tr>
	<tr>
        <th width="40%" align="left" style="font-size:12px"><?php echo "INCREMENTO"; ?> </th> 
		<td width="80%" align="right"><?php echo number_format($_SESSION['incremento'], 2, '.',','); ?></td>
	 </tr> 
	 <tr>
        <th width="40%" align="center" style="font-size:12px"><?php echo "T O T A L"; ?> </th> 
		<th width="80%" align="right"> <?php echo number_format
		                    ($_SESSION['total'] - $_SESSION['descuento'] +
							$_SESSION['incremento'], 2, '.',',');?> </td>
	    </tr>
	<tr>
        <th width="40%" align="left" style="font-size:12px"><?php echo "SERVICIOS ANTERIORES"; ?>
		    <br><?php echo "Fecha:".encadenar(16). $_SESSION['fech_sera']; ?>
			<br><?php echo "Servicio(s):".encadenar(6).$_SESSION['servicios']; ?>
			<br><?php echo "Importe:".encadenar(15).number_format($_SESSION['impo_sera'], 2, '.',','); ?>
			<br> <?php echo "Comentarios:".encadenar(2).$_SESSION['com']; ?>
			</th> 
 ...
 <?php
 //$total = $_SESSION['total'];  
 echo $total, " ", $incremento," ",$descuento;
 $consulta = "update ord_maestro set  ORD_IMPORTE = $total
              where ORD_NUMERO = $nro_ord";
$resultado = mysql_query($consulta)or die('No pudo actualizar ord_maestro : ' . mysql_error());	
