...
<form name="form2" method="post" action="solic_retro_sol.php">
 ...
 <table align="center">
  ...
  <BR><br>
    <input type="submit" name="accion" value="Consulta Cliente">
	<input type="submit" name="accion" value="Cliente Nuevo">
</form>
</div>
<div id="FooterTable">
Consulta de Cliente
