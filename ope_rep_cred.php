...
<?php
echo encadenar(55)."Detalle de ".encadenar(3)."Servicios a Credito";
?>
<br>
<?php
...
//if ($cod_mon == 1){
 ...
 ?> 
  ...
  <table border="1" width="900">
	...
	<tr>
	    ...
	    <th align="center">Fec. Servicio </th> 
 ...
 <?php  
$con_car  = "Select * From ord_credito
             where ord_cre_stat = 1
             and (ord_cre_fcob between '$f_des' and '$f_has') 
			 and ord_cre_usr_baja is null  
	         order by  ord_cre_fcob"; 
$res_car = mysql_query($con_car)or die('No pudo seleccionarse ord_credito');
$nro = 0;
$tot_impo = 0;
$tot_gas = 0;
   while ($lin_car = mysql_fetch_array($res_car)) {
         $nro_rec = $lin_car['ord_cre_nro']; 
		 $fec_s = $lin_car['ord_cre_fserv'];
		 $fec_c = $lin_car['ord_cre_fcob'];
		 $cli = $lin_car['ord_cre_clie'];
		 $impo = $lin_car['ord_cre_impo'];
         $nord = $lin_car['ord_cre_nord'];
		 $serv = $lin_car['ord_cre_serv'];
		 $ope = $lin_car['ord_cre_ope'];
		...
		/* if ($tipo == 1){
         ...
         if ($tipo == 2){
		     $tip = "G";
		     $tot_gas = $tot_gas + $impo;
			 }*/	
		$con_ope  = "Select GRAL_PAR_PRO_DESC From gral_param_propios where GRAL_PAR_PRO_GRP = 700 and GRAL_PAR_PRO_COD = $ope";
	...
	<tr>
		...
		<td align="center" ><?php echo $f_cob; ?></td>
	 	<td align="left" ><?php echo $cli; ?></td>
		<td align="left" ><?php echo $nord; ?></td>
	...
	<tr>
		...
		<td align="left" ><?php echo encadenar(2); ?></td>
		<td align="left" ><?php echo encadenar(2); ?></td>
	    <th align="right" ><?php echo number_format($tot_impo, 2, '.',','); ?></td>
		<td align="left" ><?php echo encadenar(2); ?></td>
	</tr>  
